const { postUserHandler, getProfileHandler, updateUserHandler, postActivityHandler, getHistoryHandler, getHistoryByIdHandler, postImageProfileHandler, getUserByEmailHandler, deleteOnprogressHandler, deleteAndPostHandler, getProgressHandler, getProgressByIdHandler, displayPlaceHandler, getRecomendationHandler, getRecomendationByIdHandler, getHomeByIdHandler } = require("./handler");
